...
> extends HttpClient<SecurityDataType> {
  accounts = {
     ...
     * @secure
     */
    getAccountNumbers: (params: RequestParams = {}) =>
      this.request<AccountNumberHash[], ServiceError>({
    ...
    getAccounts: (
      ...
      this.request<Account[], ServiceError>({
        path: `/accounts`,
        method: "GET",
        query: query,
        secure: true,
    ...
    getOrdersByPathParam: (
      ...
      this.request<Order[], ServiceError>({
    ...
    placeOrder: (
      ...
      this.request<void, ServiceError>({
        path: `/accounts/${accountNumber}/orders`,
        method: "POST",
        body: data,
        secure: true,
    ...
    previewOrder: (
      ...
      this.request<PreviewOrder, ServiceError>({
    ...
    getTransactionsByPathParam: (
      ...
      this.request<Transaction[], ServiceError>({
  ...
  userPreference = {
     ...
     * @secure
     */
    getUserPreference: (params: RequestParams = {}) =>
      this.request<UserPreference[], ServiceError>({
        path: `/userPreference`,
        method: "GET",
        secure: true,
        format: "json",
