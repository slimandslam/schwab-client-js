...
/** Asset Sub Type (only there if applicable) */
export declare enum EquityAssetSubType {
    COE = "COE",
    PRF = "PRF",
    ADR = "ADR",
    GDR = "GDR",
...
export declare enum AssetMainType {
    BOND = "BOND",
    EQUITY = "EQUITY",
    FOREX = "FOREX",
    FUTURE = "FUTURE",
...
export interface Bond {
    ...
    description?: string;
    exchange?: string;
    assetType?: "BOND" | "EQUITY" | "ETF" | "EXTENDED" | "FOREX" | "FUTURE" | "FUTURE_OPTION" | "FUNDAMENTAL" | "INDEX" | "INDICATOR" | "MUTUAL_FUND" | "OPTION" | "UNKNOWN";
    bondFactor?: string;
    bondMultiplier?: string;
    bondPrice?: number;
    type?: "BOND" | "EQUITY" | "ETF" | "EXTENDED" | "FOREX" | "FUTURE" | "FUTURE_OPTION" | "FUNDAMENTAL" | "INDEX" | "INDICATOR" | "MUTUAL_FUND" | "OPTION" | "UNKNOWN";
}
...
export interface Hours {
    date?: string;
    marketType?: "BOND" | "EQUITY" | "ETF" | "EXTENDED" | "FOREX" | "FUTURE" | "FUTURE_OPTION" | "FUNDAMENTAL" | "INDEX" | "INDICATOR" | "MUTUAL_FUND" | "OPTION" | "UNKNOWN";
    exchange?: string;
    category?: string;
    product?: string;
    productName?: string;
 ...
 */
export declare class MarketData<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    quotes: {
        /**
         * No description
         *
    ...
    symbolId: {
         ...
         * @secure
         */
        getQuote: (symbolId: string, query?: {
            /**
             * Request for subset of data by passing coma separated list of root nodes, possible root nodes are quote, fundamental, extended, reference, regular. Sending `quote, fundamental` in request will return quote and fundamental data in response. Dont send this attribute for full response.
             * @default "all"
             * @example "quote,reference"
    ...
    movers: {
         ...
         * @secure
         */
        getMovers: (symbolId: "$DJI" | "$COMPX" | "$SPX" | "NYSE" | "NASDAQ" | "OTCBB" | "INDEX_ALL" | "EQUITY_ALL" | "OPTION_ALL" | "OPTION_PUT" | "OPTION_CALL", query?: {
            /**
    ...
    markets: {
         ...
         * @secure
         */
        getMarketHour: (marketId: "equity" | "option" | "bond" | "future" | "forex", query?: {
            /**
             * Valid date range is from currentdate to 1 year from today. It will default to current day if not entered. Date format:YYYY-MM-DD
             * @format date
             */
